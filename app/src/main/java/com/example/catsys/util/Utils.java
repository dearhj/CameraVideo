package com.example.catsys.util;
...
public class Utils {
   ...
   public static Size fitPhotoSize(StreamConfigurationMap map,Size mWinSize){
        ...
        for(int i = 0; i< sizes.size(); i++){
            System.out.println("这里获取到的尺寸是？ " + sizes);
        }
    ...
    public static void toast(Context context, String args) {
        if (toast != null) toast.cancel();
        toast = makeText(context, args, Toast.LENGTH_SHORT);
        toast.show();
    }
}